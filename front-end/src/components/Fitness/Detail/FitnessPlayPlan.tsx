...
//     <s.Container>
//       <s.PlanHeaderArea>
//         {/* Instead of directly modifying the prop, just display the calculated sequence */}
//         <s.hidden>{props.index + 1}</s.hidden>
//         <span style={{ fontWeight: 600 }}>{props.index + 1 + '. ' + props.exercise.exerciseName}</span>
//         <s.DeleteText onClick={props.onDelete}>운동 삭제</s.DeleteText>
//       </s.PlanHeaderArea>
//       <s.PlanTable>
...
//       </s.PlanTable>
//       <s.SetBtnArea>
//         <s.PlanSetBtn onClick={handleRemoveSet}>세트 제거</s.PlanSetBtn>
//         <s.PlanSetBtn onClick={handleAddSet}>세트 추가</s.PlanSetBtn>
//       </s.SetBtnArea>
//       <s.ListLine />
//       <FitnessPlayBottomNav onFinish={props.onFinish} />
